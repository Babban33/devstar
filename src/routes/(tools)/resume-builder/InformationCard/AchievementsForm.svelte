  ...
  <div class="form-container">
    <form on:submit={formSubmit} id="projectform" >
      ...
      <div class="flex-grow sm:mt-8">
        ...
        {#if idtoadd >-1}
          <textarea id="projectdesc" name="projectdesc" class="w-full rounded-xl border border-gray-600 px-3 py-2" rows="2" bind:value="{$achievementStore[idtoadd].achievementName}" placeholder="Enter your description"></textarea>
        {:else}
