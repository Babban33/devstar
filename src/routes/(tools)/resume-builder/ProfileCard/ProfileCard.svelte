  ...
  <div class="flex justify-between mb-4">
    <div class="flex">
      ...
      <div class="flex flex-col">
        ...
        <div class="flex columns-3 gap-4">
          <a href="{$profileStore.social_media.social1}" >
          ...
          <a href="{$profileStore.social_media.social2}">
          ...
          <a href="{$profileStore.social_media.social3}">
